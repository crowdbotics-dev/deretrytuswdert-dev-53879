...
## Project Structure
    ...
    ├── deretrytuswdert_dev_53879  # Django project configurations
...
1. Clone this repo and `cd deretrytuswdert_dev_53879`
...
2. Clone this repo and `cd deretrytuswdert_dev_53879`
